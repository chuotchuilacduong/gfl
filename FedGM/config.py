...
supported_fl_algorithm = ["isolate", "fedavg", "fedprox",
                          ...
                          "fgssl", "fedgl", "fedhgn3", "fedgm","fedrgd", "hyperion","fedigl", "fedlog"]
...
# FedLoG settings
parser.add_argument('--pre_gen_epochs', type=int, default=200, help='Epochs for generator pretraining')
parser.add_argument('--pre_epochs', type=int, default=200, help='Epochs for local model pretraining')
parser.add_argument('--head_deg_thres', type=int, default=10, help='Degree threshold for head/tail separation')
parser.add_argument('--hyper_metric', type=float, default=10, help='Hyperparameter for metric loss')
