...
supported_fl_algorithm = ["isolate", "fedavg", "fedprox", "scaffold", "moon", "feddc", "fedproto", "fedtgp", "fedpub", "fedstar", "fedgta", "fedtad", "gcfl_plus", "fedsage_plus", "adafgl", "feddep", "fggp", "fgssl", "fedgl", "fedhgn3", "fedgm","fedgm_hybrid","fedrgd"]
...
# --- FedRGD Specific Settings  ---
parser.add_argument("--condense_iters", type=int, default=300, help="Number of matching iterations on Client (Task 2)")
parser.add_argument("--lr_feat", type=float, default=1e-3, help="Learning rate for synthetic node features")
parser.add_argument("--lr_adj", type=float, default=1e-3, help="Learning rate for synthetic graph structure (PGE)")
parser.add_argument("--local_epochs", type=int, default=5, help="Number of local training epochs in FL")
parser.add_argument("--num_global_syn_nodes", type=int, default=200, help="Number of synthetic nodes for Server-side condensation")

parser.add_argument("--server_condense_iters", type=int, default=300, help="Number of matching iterations on Server")
